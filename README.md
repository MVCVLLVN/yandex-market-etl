...
## Почему так
- Скроллинг идёт до достижения нужного количества карточек.
- Сбор точно фиксирован на момент времени.
- Лёгкая история цен и рейтингов.
- Код читаемый, не перегруженный.
